...
Script to run jGNN training for the non-linear geophysics problem.
"""
...
parameters_file = "FastABC/data/geo_nonlinear/parameters_matern32_Mu10_Var1p96_CorH30_CorV15_eikonal-nl_81_10k.txt"
...
geo_jGNN_exp = jGNN_SuS_exp(
    parameters_file,
    name="NonLin_Geo_jGNN_SuS_Matern_81",
    seed=seed,
    run_id=None,
    gpu_id=gpu_id,
