"""
Adapted from https://github.com/aaron-xichen/pytorch-playground/blob/master/mnist/train.py
Adapted by Eliane Maalouf
Script to train a MNIST classifier
"""
...
parser.add_argument(
    "--lr", type=float, default=0.01, help="learning rate (default: 1e-3)"
)
parser.add_argument("--gpu", default="cuda:0", help="index of gpus to use")
...
parser.add_argument(
    "--data_root",
    default="/tmp/public_dataset/pytorch/",
    help="folder to save the model",
)
parser.add_argument("--decreasing_lr", default="80,120", help="decreasing strategy")
args = parser.parse_args()
resultroot = "..."  # TODO: set your result root path here
# args.logdir = os.path.join(os.path.dirname(__file__), args.logdir)
args.logdir = os.path.join(resultroot, args.logdir)
...
# data loader
train_loader, test_loader = dataset.get(
    batch_size=args.batch_size, data_root=args.data_root, num_workers=1
)

# model
model = model.mnist(input_dims=1024, n_hiddens=[256, 256], n_class=10)
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, (data, target) in enumerate(train_loader):
            ...
            if batch_idx % args.log_interval == 0 and batch_idx > 0:
                ...
                print(
                    "Train Epoch: {} [{}/{}] Loss: {:.6f} Acc: {:.4f} lr: {:.2e}".format(
                        epoch,
                        batch_idx * len(data),
